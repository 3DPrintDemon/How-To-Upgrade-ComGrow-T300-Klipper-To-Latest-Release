...
copy these out to your new `macros.cfg` that you should create, uncomment them so the macro is active & set values to your preference, find them in the `mainsail.cfg`. Dont use these AND the Comgrow ones!
